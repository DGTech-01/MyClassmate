...
namespace MVC.Web.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Dashboard()
        {
            ...
            DataTable UserDetail = visitorRepository.GetUserDetails(userid, roleid);
            ...
            DataTable MonthlyPass = visitorRepository.GetCountForMonthlyPass(userid, roleid);
            ViewBag.MonthlyPass= MonthlyPass.Rows[0][1].ToString();
        ...
        public PartialViewResult GetChaPassByToken(string token)
        {

            MonthlyPass monthlyPassModel = chaPassRepository.FetchMonthyPassDetails(token);

            return PartialView("_ChaMonthPass", monthlyPassModel);
        }
